...
{
	{{0, ID_FILE_NEW  , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 0}, TEXT("リストをクリア")     },
	{{1, ID_OPEN_FOLDER , TBSTATE_ENABLED, TBSTYLE_BUTTON | TBSTYLE_DROPDOWN /* StartInaction 053 */, 0, 1}, TEXT("フォルダを開く")    },
	{{2, ID_SAVE_ALL_TAG , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 2}, TEXT("タグ情報を更新")    },
	{{3, ID_SELECT_EDIT_DESTORY  , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 3}, TEXT("編集前の状態に戻す")     },
	{{0, ID_SEPARATOR , TBSTATE_ENABLED, TBSTYLE_SEP   , 0, 4}, TEXT("")        },
	{{4, ID_EDIT_CUT , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 5}, TEXT("切り取り")    },
	{{5, ID_EDIT_COPY, TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 6}, TEXT("コピー")   },
	{{6, ID_EDIT_PASTE, TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 7}, TEXT("貼り付け")   },
	{{0, ID_SEPARATOR , TBSTATE_ENABLED, TBSTYLE_SEP   , 0, 8}, TEXT("")        },
	{{7, ID_CELL_COPY_DOWN , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 9}, TEXT("下方向へコピー")},
	{{0, ID_SEPARATOR , TBSTATE_ENABLED, TBSTYLE_SEP   , 0, 10}, TEXT("")        },
	{{8, ID_EDIT_TD3_TAG , TBSTATE_ENABLED, TBSTYLE_CHECK, 0, 11}, TEXT("ID3 tagを表示／編集")},
	{{9, ID_EDIT_FIELD_SI , TBSTATE_ENABLED, TBSTYLE_CHECK, 0, 12}, TEXT("SIフィールドを表示／編集")},
	{{0, ID_SEPARATOR , TBSTATE_ENABLED, TBSTYLE_SEP   , 0, 13}, TEXT("")        },
	{{10, ID_WINAMP_PLAY_PREV , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 14}, TEXT("前の曲へ")},
	{{11, ID_WINAMP_PLAY , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 15}, TEXT("再生")},
	{{12, ID_WINAMP_STOP , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 16}, TEXT("停止")},
	{{13, ID_WINAMP_PLAY_NEXT , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 17}, TEXT("次の曲へ")},
	{{0, ID_SEPARATOR , TBSTATE_ENABLED, TBSTYLE_SEP   , 0, 18}, TEXT("")        },
	{{14, ID_DLG_ENVIRONMENT , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 19}, TEXT("オプション")},
	{{15, ID_APP_ABOUT , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 20}, TEXT("バージョン情報")},
	{{0, ID_SEPARATOR , TBSTATE_ENABLED, TBSTYLE_SEP   , 0, 21}, TEXT("")        },
	{{16, ID_CONV_FORMAT_USER , TBSTATE_ENABLED, TBSTYLE_BUTTON | TBSTYLE_DROPDOWN, 0, 22}, TEXT("ユーザ書式切替")},
	{{17, ID_SET_NUMBER , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 23}, TEXT("下方向へ連番")},
	{{18, ID_SET_NUMBER_ADD , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 24}, TEXT("下方向へ連番を追加")},
	{{19, ID_SELECT_TREE_COLUM , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 25}, TEXT("ツリー配下のセル一括選択")},
	{{20, ID_TEIKEI_TOOL , TBSTATE_ENABLED, TBSTYLE_BUTTON | TBSTYLE_DROPDOWN, 0, 26}, TEXT("定型文貼り付け")},
	{{21, ID_CHECK_FILENAME_MAX , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 27}, TEXT("ファイル名の長さをチェック")},
	{{22, ID_SELECT_DELETE_LIST , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 28}, TEXT("リストから削除")},
	{{23, ID_DELETE_CHAR , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 29}, TEXT("先頭/末尾のｎ文字を削除")},
	{{24, ID_UNIFY_CHAR , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 30}, TEXT("文字種の統一")},
	{{25, ID_END_EDIT_RIGHT , TBSTATE_ENABLED, TBSTYLE_CHECK, 0, 31}, TEXT("項目変更後にカーソルを右に移動")}, /* BeachMonster 091 */
	{{26, ID_FAVORITES_FOLDER , TBSTATE_ENABLED, TBSTYLE_BUTTON | TBSTYLE_DROPDOWN, 0, 32}, TEXT("お気に入りのフォルダ")}, /* RockDance 129 */
	{{27, ID_CALC_FOLDER_TOTAL , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 33}, TEXT("合計の算出")}, /* RockDance 128 */
	{{28, ID_EDIT_PASTE_ADD , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 34}, TEXT("追加で貼り付け")}, /* Baja 171 */
	{{29, ID_DELETE_CHAR_SPACE , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 35}, TEXT("先頭/末尾の空白文字を削除")}, /* Rumble 192 */
	{{30, ID_SELECT_TREE_FILE , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 36}, TEXT("ツリー配下のファイル一括選択")}, /* STEP 013 */
	{{31, ID_MOVE_TO_PARENT , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 37}, TEXT("カーソルを親ツリーへ移動")}, /* STEP 014 */
//	{{32, ID_MOVE_TO_PREVIOUS , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 38}, TEXT("カーソル位置を一つ上のツリーへ移動")}, /* STEP 014 */
//	{{33, ID_MOVE_TO_NEXT , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 39}, TEXT("カーソル位置を一つ下のツリーへ移動")}, /* STEP 014 */
	{{32, ID_DLG_SETUP_PLUGIN , TBSTATE_ENABLED, TBSTYLE_BUTTON, 0, 38}, TEXT("プラグインオプション")}, /* STEP 039*/
	/**
...
{
	static	CString	str;
	str.Format(TEXT("%d：%d"), (signed short)((lParam>>16)&0xffff), (signed short)(lParam&0xffff));
	m_wndStatusBar.SetPaneText(m_wndStatusBar.CommandToIndex(ID_INDICATOR_LOCATION), implicit_cast<LPCTSTR>(str));
	...
	case ID_CONV_FORMAT_USER:
		{
			...
			strName.Format(TEXT("04：%s"), g_userConvFormat[3].strName); /* LastTrain 057 */
			pPopup->ModifyMenu((UINT)ID_CONV_FORMAT_USER_04, MF_BYCOMMAND, ID_CONV_FORMAT_USER_04, (LPCTSTR)strName);
			strName.Format(TEXT("05：%s"), g_userConvFormat[4].strName); /* LastTrain 057 */
